...
# Work around numba caching issue in packaged environments (like AWS Lambda)
# Error was: "cannot cache function '_make_tree': no locator available for file ..."
# Setting sys.frozen helps numba skip its normal file-locator logic.
